...
//             $user = new user();
//             $checkpass = $user->checkPassbyEmail($email)[0];
//             var_dump($mhnewPass);
//             var_dump($checkpass);
//             if ($mhcurrentPass === $checkpass) {
//                 echo"mật khẩu khớp";
//                 var_dump($user->changePasswNewpass($mhnewPass, $email));
//                 if ($user->changePasswNewpass($mhnewPass, $email)) {
